<template>
  <div class="FilmBarChart" id="FilmBarChart"></div>
</template>

<script>
import * as echarts from "echarts";
import {getFilmStats} from "@/api/stats"
...
export default {
  ...
  methods: {
    getBar () {
      // 绘制图表
      var myChart = echarts.init(document.getElementById("FilmBarChart"));
