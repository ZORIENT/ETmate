...
.table >>> .el-table td:nth-child(4) div button{
  color: var(--primaryColor);
}

.table >>> .el-table td:nth-child(4) div button:hover{
  opacity: 0.9;
}

.table >>> .el-table td:nth-child(4) div button:nth-child(2){
  color: #dd0000;
}

.table >>> .el-table td:nth-child(4) div button:nth-child(2):hover{
  color: #dd0000;
  opacity: 0.9;
}
